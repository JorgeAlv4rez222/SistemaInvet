...
export function ImportarNotaRevisionFlow({ adminId, onVolver, onCreada }: Props) {
  ...
  async function handleCrear() {
    ...
    try {
      ...
      // Enviar directamente a revisión (omite la etapa de picking)
      await notasApi.enviarARevision({ adminId, notaId: resultado.notaId })
      ...
      {paso === 'preview' && (
        <>
          <div className="ing-detalle-meta">
            <div className="ing-meta-item">
              <div>
                ...
                <input className="ing-meta-input" type="text" value={numeroNota} onChange={(e) => setNumeroNota(e.target.value)} placeholder="12345" />
              </div>
            </div>
            <div className="ing-meta-item">
              <div>
                <span className="ing-meta-label">Cliente <span className="requerido">*</span></span>
                <input className="ing-meta-input" type="text" value={nombreCliente} onChange={(e) => setNombreCliente(e.target.value)} placeholder="Nombre del cliente" />
              </div>
            </div>
            <div className="ing-meta-item">
              <div>
                <span className="ing-meta-label">RUT cliente <span className="requerido">*</span></span>
                <input className="ing-meta-input" type="text" value={rutCliente} onChange={(e) => setRutCliente(e.target.value)} placeholder="12.345.678-9" />
              </div>
            </div>
            <div className="ing-meta-item">
              <div>
                <span className="ing-meta-label">N° OC <span className="opcional">opcional</span></span>
                <input className="ing-meta-input" type="text" value={numeroOc} onChange={(e) => setNumeroOc(e.target.value)} placeholder="—" />
              </div>
            </div>
            <div className="ing-meta-item">
              <div>
          ...
          <div className="importar-acciones">
            ...
            >
              {creando ? 'Creando…' : `Importar para revisión (${totalEncontrados} productos)`}
            </button>
          </div>
